  ...
  return (
    <>
      ...
      >
        ...
        <span className="inline-block ml-4">请输入面试问题</span>
        <kbd
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] text-black">
          <DialogHeader>
            <DialogTitle>AI 面试助手</DialogTitle>
            <DialogDescription>
              我是您面试助手，请输入您想查询的问题
            </DialogDescription>
            <hr />
            ...
            <div className="grid gap-4 py-4 text-slate-700">
              ...
              <div className="text-xs text-gray-500 md:flex space-y-2 md:space-y-0 gap-2 dark:text-gray-100">
                ...
                <button
                  ...
                  transition-colors"
                  onClick={(_) =>
                    setSearch('互斥锁、自旋锁、读写锁、悲观锁、乐观锁的应用场景')
                  }
                >
